...
LocationManager.prototype._registerDelegateCallbackId = function () {
	...
	exec(_.bind(this._onDelegateCallback, this, d), _.bind(this._onDelegateCallback, this, d), 'LocationManager', 'registerDelegateCallbackId', []);
...
LocationManager.prototype.isLocationEnabled = function () {
	return this._promisedExec('isLocationEnabled', [], []);
};
...
LocationManager.prototype.startRangingBeaconsInRegion = function (region) {
	if (!Regions.isBeaconRegion(region)) throw new TypeError('The region parameter has to be an instance of BeaconRegion');
...
LocationManager.prototype.startAdvertising = function (region, measuredPower) {
	Regions.checkRegionType(region);
	if (measuredPower) return this._promisedExec('startAdvertising', [region, measuredPower], []);
